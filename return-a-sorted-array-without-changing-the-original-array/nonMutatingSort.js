...
// (remember that slice and concat return a new array), then run the sort
// method.

// Use the sort method in the nonMutatingSort function to sort the elements of
// an array in ascending order. The function should return a new array, and not
...
function nonMutatingSort(arr) {
    ...
    //Or, also many other ways to copy an array:
    //const sortArray = arr.concat();
    //return sortArray.sort((a, b) => a - b);
