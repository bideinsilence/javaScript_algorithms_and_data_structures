...
// added or removed over time; in other words, arrays are mutable. In this
// challenge, we will look at two methods with which we can programmatically
...
// We have defined a function, mixedNumbers, which we are passing an array as an
// argument. Modify the function by using push() and unshift() to add 'I', 2,
// 'three' to the beginning of the array and 7, 'VIII', 9 to the end so that the
