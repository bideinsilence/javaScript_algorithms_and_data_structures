...
// Using a for loop, this function iterates through and accesses each element of
// the array, and subjects it to a simple test that we have created. In this
// way, we have easily and programmatically determined which data items are
// greater than 10, and returned a new array, [12, 14, 80], containing those
// items.
...
// that may or may not be present on one or more of the arrays nested within
// arr. Modify the function, using a for loop, to return a filtered version of
// the passed array such that any array nested within arr containing elem has
// been removed.
