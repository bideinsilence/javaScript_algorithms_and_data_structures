...
// In an array, each array item has an index. This index doubles as the position
// of that item in the array, and how you reference it. However, it is important
// to note, that JavaScript arrays are zero-indexed, meaning that the first
// element of an array is actually at the zeroth position, not the first. In
// order to retrieve an element from an array we can enclose an index in
...
// b, to not b anymore. Now ourArray is ["a", "not b anymore", "c"].

// In order to complete this challenge, set the 2nd position (index 1) of
// myArray to anything you want, besides the letter b.
